...
namespace Plugin::Papyrus::IO::Toml
{
		...
		std::filesystem::path a_path)
	{
		...
		return ::Plugin::Internal::IO::TomlFile::IsCachedAsVariantMap(*(tempMap.get()), a_path);
	}
		...
		std::filesystem::path a_path)
	{
		...
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->CacheAsVariantMap(*(tempMap.get()), a_path);
	}
		...
		RE::BSFixedString a_targetNamespace)
	{
		...
		auto tempMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->CacheAsVariantMapTo(*(tempMap.get()), a_sourcePath, a_targetNamespace);
	}
		...
		std::filesystem::path a_path)
	{
		...
		auto tempMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->UncacheAsVariantMap(*(tempMap.get()), a_path);
	}
		...
		std::filesystem::path a_path)
	{
		...
		auto tempMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->SaveCachedAsVariantMap(*(tempMap.get()), a_path);
	}
		...
		std::filesystem::path a_targetPath)
	{
		...
		auto tempMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->SaveCachedAsVariantMapTo(*(tempMap.get()), a_sourceNamespace, a_targetPath);
	}
		...
		std::filesystem::path a_path)
	{
		...
		return ::Plugin::Internal::IO::TomlFile::IsCachedAsVariantMap(*(memMap.get()), a_path);
	}
		...
		std::filesystem::path a_path)
	{
		...
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->CacheAsVariantMap(*(memMap.get()), a_path);
	}
		...
		RE::BSFixedString a_targetNamespace)
	{
		...
		auto memMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetMemoryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->CacheAsVariantMapTo(*(memMap.get()), a_sourcePath, a_targetNamespace);
	}
		...
		std::filesystem::path a_path)
	{
		...
		auto memMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetMemoryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->UncacheAsVariantMap(*(memMap.get()), a_path);
	}
		...
		std::filesystem::path a_path)
	{
		...
		auto memMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetMemoryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->SaveCachedAsVariantMap(*(memMap.get()), a_path);
	}
		...
		std::filesystem::path a_targetPath)
	{
		...
		auto memMap = ::Plugin::GetInternalManager()->GetScriptManager()->GetMemoryMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->SaveCachedAsVariantMapTo(*(memMap.get()), a_sourceNamespace, a_targetPath);
	}
		...
		std::filesystem::path a_path)
	{
		...
		return ::Plugin::Internal::IO::TomlFile::IsCachedAsVariantMap(*(saveMap.get()), a_path);
	}
		...
		std::filesystem::path a_path)
	{
		...
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->CacheAsVariantMap(*(saveMap.get()), a_path);
	}
		...
		RE::BSFixedString a_targetNamespace)
	{
		...
		auto saveMap = ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->CacheAsVariantMapTo(*(saveMap.get()), a_sourcePath, a_targetNamespace);
	}
		...
		std::filesystem::path a_path)
	{
		...
		auto saveMap = ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->UncacheAsVariantMap(*(saveMap.get()), a_path);
	}
		...
		std::filesystem::path a_path)
	{
		...
		auto saveMap = ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->SaveCachedAsVariantMap(*(saveMap.get()), a_path);
	}
		...
		std::filesystem::path a_targetPath)
	{
		...
		auto saveMap = ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantMap();
		return ::Plugin::GetInternalManager()->GetIOManager()->GetTomlFile()->SaveCachedAsVariantMapTo(*(saveMap.get()), a_sourceNamespace, a_targetPath);
	}
