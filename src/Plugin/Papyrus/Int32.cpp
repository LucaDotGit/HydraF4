...
namespace Plugin::Papyrus::Int32
{
	...
	using DoubleSstruct = ::Plugin::Internal::Structs::Float64::DoubleData;

	static std::int32_t Copy(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return a_value;
	}
	...
	static LongStruct ToLong(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return LongStruct::FromInt32(a_value);
	}
	...
	static DoubleSstruct ToDouble(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return DoubleSstruct::FromInt32(a_value);
	}

	static std::int32_t FromString(RE::BSScript::StaticTag /*a_staticTag*/,
		std::string_view a_value,
		REX::IntFormat a_base,
		std::int32_t a_default)
	{
		const auto result = REX::FromString<std::int32_t>(a_value, a_base);
		if (!result.has_value()) {
			return a_default;
		}
	...
	static std::int32_t MinValue(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return std::numeric_limits<std::int32_t>::min();
	}

	static std::int32_t MaxValue(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return std::numeric_limits<std::int32_t>::max();
	}

	static std::int32_t Add(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
	...
	static std::int32_t Subtract(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
		return a_left - a_right;
	...
	static std::int32_t Multiply(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
		return a_left * a_right;
	...
	static std::int32_t Divide(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
		if (a_right == 0) {
	...
	static std::int32_t Modulo(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
	...
	static std::int32_t Negate(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return -a_value;
	}

	static std::int32_t LeftShift(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value,
		std::int32_t a_shift)
	{
	...
	static std::int32_t RightShift(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value,
		std::int32_t a_shift)
	{
		return a_value >> a_shift;
	...
	static std::int32_t BitwiseAnd(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
		return a_left & a_right;
	...
	static std::int32_t BitwiseOr(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
		return a_left | a_right;
	...
	static std::int32_t BitwiseXor(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
		return a_left ^ a_right;
	...
	static std::int32_t BitwiseNot(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return ~a_value;
	}
	...
	static std::int32_t SetFlag(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value,
		std::int32_t a_flag,
		bool a_set)
	{
	...
	static std::int32_t Abs(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return std::abs(a_value);
	}

	static std::int32_t Min(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
	...
	static std::int32_t Max(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
	...
	static std::int32_t Clamp(RE::BSScript::IVirtualMachine& a_vm, RE::BSScript::StackID a_stackId, RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value,
		std::int32_t a_min,
		std::int32_t a_max)
	{
	...
	static std::int32_t CopySign(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value,
		std::int32_t a_sign)
	{
		return static_cast<std::int32_t>(std::copysign(a_value, a_sign));
	}

	static std::int32_t Lcm(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
	...
	static std::int32_t Gcd(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_left,
		std::int32_t a_right)
	{
	...
	static std::int32_t Fib(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return REX::Fib(a_value);
	}

	static std::int32_t Fact(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_value)
	{
		return REX::Fact(a_value);
	}

	static std::int32_t Perm(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_n,
		std::int32_t a_r)
	{
	...
	static std::int32_t Comb(RE::BSScript::StaticTag /*a_staticTag*/,
		std::int32_t a_n,
		std::int32_t a_r)
	{
