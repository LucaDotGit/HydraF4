...
namespace Plugin::Papyrus::Int64
{
	...
	{
		const auto result = REX::FromString<std::int64_t>(a_value, a_base);
		if (!result.has_value()) {
			return a_default;
		}

		return LongStruct::FromInt64(result.value());
	}
		...
		REX::IntFormat a_base)
	{
		...
		auto result = REX::ToString(LongStruct::ToInt64(a_value.value()), a_base);
		...
		std::string_view a_default)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
	...
	{
		return LongStruct::FromInt64(std::numeric_limits<std::int64_t>::min());
	}

	static std::optional<LongStruct> MaxValue(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return LongStruct::FromInt64(std::numeric_limits<std::int64_t>::max());
	}
		...
		std::optional<LongStruct> a_right)
	{
		...
		const auto left64 = LongStruct::ToInt64(a_left.value());
		const auto right64 = LongStruct::ToInt64(a_right.value());

		return LongStruct::FromInt64(left64 + right64);
	}
		...
		std::optional<LongStruct> a_right)
	{
		...
		const auto left64 = LongStruct::ToInt64(a_left.value());
		const auto right64 = LongStruct::ToInt64(a_right.value());
		const auto result64 = REX::Mod(left64, right64);

		return LongStruct::FromInt64(result64);
	}

	static std::optional<LongStruct> Negate(RE::BSScript::IVirtualMachine& a_vm, RE::BSScript::StackID a_stackId, RE::BSScript::StaticTag /*a_staticTag*/,
		std::optional<LongStruct> a_value)
	{
		if (!a_value.has_value()) [[unlikely]] {
			a_vm.PostError(::Plugin::Internal::Script::ScriptErrors::STRUCT_NULL, a_stackId);
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		return LongStruct::FromInt64(-value64);
	}
		...
		std::int32_t a_shift)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		return LongStruct::FromInt64(value64 << a_shift);
	}
		...
		std::optional<LongStruct> a_flag)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		const auto flag64 = LongStruct::ToInt64(a_flag.value());
	...
	static std::optional<LongStruct> Abs(RE::BSScript::IVirtualMachine& a_vm, RE::BSScript::StackID a_stackId, RE::BSScript::StaticTag /*a_staticTag*/,
		std::optional<LongStruct> a_value)
	{
		if (!a_value.has_value()) [[unlikely]] {
			a_vm.PostError(::Plugin::Internal::Script::ScriptErrors::STRUCT_NULL, a_stackId);
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		return LongStruct::FromInt64(std::abs(value64));
	}
		...
		std::optional<LongStruct> a_right)
	{
		...
		return LongStruct::FromInt64(std::min(left64, right64));
	}
		...
		std::optional<LongStruct> a_right)
	{
		...
		return LongStruct::FromInt64(std::max(left64, right64));
	}
		...
		std::optional<LongStruct> a_max)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		const auto min64 = LongStruct::ToInt64(a_min.value());
		const auto max64 = LongStruct::ToInt64(a_max.value());
		...
		return LongStruct::FromInt64(std::clamp(value64, min64, max64));
	}
		...
		std::optional<LongStruct> a_value)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		return LongStruct::FromInt64(std::signbit(value64) ? -1 : 1);
	}
		...
		std::optional<LongStruct> a_sign)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		const auto sign = LongStruct::ToInt64(a_sign.value());

		return LongStruct::FromInt64(static_cast<std::int64_t>(std::copysign(value64, sign)));
	}
		...
		std::optional<LongStruct> a_right)
	{
		...
		return LongStruct::FromInt64(std::lcm(left64, right64));
	}
		...
		std::optional<LongStruct> a_right)
	{
		...
		return LongStruct::FromInt64(std::gcd(left64, right64));
	}
		...
		std::optional<LongStruct> a_value)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		return LongStruct::FromInt64(REX::Fib(value64));
	}
		...
		std::optional<LongStruct> a_value)
	{
		...
		const auto value64 = LongStruct::ToInt64(a_value.value());
		return LongStruct::FromInt64(REX::Fact(value64));
	}
		...
		std::optional<LongStruct> a_r)
	{
		...
		const auto n64 = LongStruct::ToInt64(a_n.value());
		const auto r64 = LongStruct::ToInt64(a_r.value());

		return LongStruct::FromInt64(REX::Perm(n64, r64));
	}
		...
		std::optional<LongStruct> a_r)
	{
		...
		return LongStruct::FromInt64(REX::Comb(n64, r64));
	}
