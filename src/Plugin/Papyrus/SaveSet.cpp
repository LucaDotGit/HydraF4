...
namespace Plugin::Papyrus::SaveSet
{
	...
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->IsNamespaceValid(a_namespace);
	}

	static std::vector<RE::BSFixedString> GetNamespaces(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->GetSortedNamespaces();
	}

	static std::vector<RE::BSScript::UniqueVariant> GetKeys(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->GetSortedKeys(a_namespace);
	}

	static std::size_t GetNamespaceSize(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->GetNamespaceSize();
	}

	static bool ContainsNamespace(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->ContainsNamespace(a_namespace);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->ContainsKey(a_namespace, a_key);
	}
	...
	static bool Add(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_key)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->Add(a_namespace, a_key);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->AddRange(a_namespace, a_key);
	}
	...
	static bool RemoveKey(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_key)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->RemoveKey(a_namespace, a_key);
	}

	static bool RemoveNamespace(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetSaveManager()->GetScriptVariantSet()->RemoveNamespace(a_namespace);
	}
