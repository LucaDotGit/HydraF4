...
namespace Plugin::Papyrus::TempMap
{
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetSortedNamespaces();
	}

	static std::vector<RE::BSScript::UniqueVariant> GetKeys(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetSortedKeys(a_namespace);
	}

	static std::vector<RE::BSScript::UniqueVariant> GetValues(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetSortedValues(a_namespace);
	}

	static std::vector<std::optional<VarPairStruct>> GetPairs(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetPairs(a_namespace);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->SetPairs(a_namespace, a_pairs);
	}

	static std::size_t GetNamespaceSize(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetNamespaceSize();
	}

	static std::size_t GetKeySize(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetKeySize(a_namespace);
	}

	static bool ContainsNamespace(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->ContainsNamespace(a_namespace);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->ContainsKey(a_namespace, a_key);
	}
	...
	static RE::BSScript::UniqueVariant GetValue(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_key)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetValue(a_namespace, a_key);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetValueOrDefault(a_namespace, a_key, a_default);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->SetValue(a_namespace, a_key, a_value);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->Update(a_namespace, a_key, a_newValue, a_compareValue);
	}
	...
	static bool Add(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_value)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->Add(a_namespace, a_key, a_value);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->AddOrUpdate(a_namespace, a_key, a_addValue, a_updateValue);
	}
	...
	static RE::BSScript::UniqueVariant GetOrAdd(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_value)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->GetOrAdd(a_namespace, a_key, a_value);
	}
	...
	static bool RemoveKey(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_key)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->RemoveKey(a_namespace, a_key);
	}

	static bool RemoveNamespace(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporaryMap()->RemoveNamespace(a_namespace);
	}
