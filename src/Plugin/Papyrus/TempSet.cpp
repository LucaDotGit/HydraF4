...
namespace Plugin::Papyrus::TempSet
{
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->GetSortedNamespaces();
	}

	static std::vector<RE::BSScript::UniqueVariant> GetKeys(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->GetSortedKeys(a_namespace);
	}

	static std::size_t GetNamespaceSize(RE::BSScript::StaticTag /*a_staticTag*/)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->GetNamespaceSize();
	}

	static bool ContainsNamespace(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->ContainsNamespace(a_namespace);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->ContainsKey(a_namespace, a_key);
	}
	...
	static bool Add(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_key)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->Add(a_namespace, a_key);
	}
	...
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->AddRange(a_namespace, a_key);
	}
	...
	static bool RemoveKey(RE::BSScript::StaticTag /*a_staticTag*/,
		...
		RE::BSScript::SharedVariant a_key)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->RemoveKey(a_namespace, a_key);
	}

	static bool RemoveNamespace(RE::BSScript::StaticTag /*a_staticTag*/,
		RE::BSFixedString a_namespace)
	{
		return ::Plugin::GetInternalManager()->GetScriptManager()->GetTemporarySet()->RemoveNamespace(a_namespace);
	}
